...
public class PluginConfig
{
    ...
    public PluginConfig(ConfigFile cfg)
    {
        ...
        ShotgunRarity = cfg.Bind<int>(Categories.Shotgun, "Rarity", -1, "Rarity of shotgun spawn on moons (higher = more common). A shotgun will also appear in gifts. Set to -1 to disable it from appearing").Value;
        ...
        ShotgunShellPrice = cfg.Bind<int>(Categories.Shell, "Price", 50, "Cost of a shotgun shell in a store. Set -1 to remove the shotgun shells from sale").Value;
        ...
        ShotgunShellRarity = cfg.Bind<int>(Categories.Shell, "Rarity", 2, "Rarity of shotgun shells appearing on moons (higher = more common). Shell will also appear in gifts. Set to -1 to disable their spawning").Value;
